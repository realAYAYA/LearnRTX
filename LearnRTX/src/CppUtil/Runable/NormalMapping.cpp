...
//
//    // New Code
//    unsigned int diffuseMap = LoadImageToGPU((exePath.substr(0, exePath.find_last_of('\\')) + "\\Assets\\textures\\brickwall.jpg").c_str());
//    unsigned int normalMap = LoadImageToGPU((exePath.substr(0, exePath.find_last_of('\\')) + "\\Assets\\textures\\brickwall_normal.jpg").c_str());
//    
