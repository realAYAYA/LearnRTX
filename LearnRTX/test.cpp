...
//   
//    Shader shaderGeometryPass(shaderPath + "gBuffer.vs", shaderPath + "gBuffer.fs");
//    Shader shaderLightingPass(shaderPath + "deferredShading.vs", shaderPath + "deferredShading.fs");
//    Shader shaderRTX(shaderPath + "deferredShading.vs", /*shaderPath +*/"Blur.frag");// temp test
//    Shader shaderLightBox(shaderPath + "deferredLightBox.vs", shaderPath + "deferredLightBox.fs");
//    if (!shaderGeometryPass.IsValid() && !shaderLightingPass.IsValid() && !shaderLightBox.IsValid()) {
...
//    int sceneDataSize = Fit2Square(data);
...
//
//    shaderLightingPass.SetInt("PackData", 3);// Test
//
...
//
//        VAO_Screen.Draw(shaderLightingPass);// Draw Screen-gBuffer
//
